                  ...
                  <div class="x_content">
                    ...
                    <div class="col-xs-3">
                      ...
                      <ul class="nav nav-tabs tabs-left">
                        ...
                        <li class="active"><a href="${locationTabUrl}">Location</a>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div class="col-xs-9">
                      ...
                      <div class="tab-content">
                        <div class="tab-pane active" id="home">
                          ...
                          <spring:url value="/user/${userid}/location/addNew" var="addNewUrl"/>
                            <a href="${addNewUrl}">
                              <input type="button" class="btn btn-success btn-md" value="Add new location"/>
                            </a>
                          </p>
                      ...
                      <table class="table table-striped jambo_table">
                        ...
                        <c:forEach var="location" items="${listLocation}">
                          <tr class="pointer">
                            ...
                            <td class=" ">${location.time}</td>
                            <td class=" last">
                              <spring:url value="/user/${userid}/location/delete/${location.id}" var="deleteUrl"/>
                              <spring:url value="/user/${userid}/location/${location.id}" var="editUrl"/>
