                  ...
                  <div class="x_content">
                    ...
                    <div class="col-xs-3">
                      ...
                      <ul class="nav nav-tabs tabs-left">
                        ...
                        <li class="active"><a href="#profile" data-toggle="tab">Friend</a>
                        </li>
                        <li><a href="#messages" data-toggle="tab">Location</a>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div class="col-xs-9">
                      ...
                      <div class="tab-content">
                        <div class="tab-pane active" id="home">
                          <p class="lead">Edit Relationship</p>
                          <form class="form-horizontal form-label-left" novalidate>

                      
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Friend Username <span class="required">*</span>
                        </label>
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Check accept <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="checkbox">
                        </div>
