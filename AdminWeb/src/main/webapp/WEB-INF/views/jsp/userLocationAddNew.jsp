                  ...
                  <div class="x_content">
                    ...
                    <div class="col-xs-3">
                      ...
                      <ul class="nav nav-tabs tabs-left">
                        <li><a href="#home" data-toggle="tab">Information</a>
                        </li>
                        <li><a href="#profile" data-toggle="tab">Friend</a>
                        </li>
                        <li class="active"><a href="#messages" data-toggle="tab">Location</a>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div class="col-xs-9">
                      ...
                      <div class="tab-content">
                        <div class="tab-pane active" id="home">
                          ...
                          <spring:url value="/user/${userid}/location/addNew/add" var="addLocationUrl"/>
                          <form class="form-horizontal form-label-left" action="${addLocationUrl}" method="post">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input class="form-control col-md-7 col-xs-12" type="text" name="longitude">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" class="form-control col-md-7 col-xs-12" name="latitude">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" class="form-control col-md-7 col-xs-12" name="time">
                        </div>
                      </div>
